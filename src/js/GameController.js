...
export default class GameController {
  ...
  init() {
    ...
    const playerTeam = generateTeam([Bowman, Swordsman, Magician], this.level, 3).next().value;
    const enemyTeam = generateTeam([Vampire, Daemon, Undead], this.level, 3).next().value;
